...
[![GitHub Releases](https://img.shields.io/badge/GitHub-microsoft/WSL-181717?style=flat&logo=github&logoColor=white)](https://github.com/microsoft/WSL/releases/latest)

下载最新的 `Microsoft.WSL_x.x.x.x_x64_ARM64.msixbundle` 文件，双击安装，安装完成后**重启电脑**。

### 下载安装

[![官网](https://img.shields.io/badge/Docker_Desktop-下载-2496ED?style=flat&logo=docker&logoColor=white)](https://www.docker.com/products/docker-desktop/)
